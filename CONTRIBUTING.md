...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/import-regex
   cd import-regex
   ```
...
```sh
https://github.com/flex-development/import-regex/compare/main...$branch
```
...
[19]: https://github.com/flex-development/import-regex/discussions/new?category=q-a
